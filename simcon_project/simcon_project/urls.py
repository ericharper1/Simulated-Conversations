...
from users.views import RedirectFromLogin, StudentView, ResearcherView, ViewResponse, UpdateResponseFeedback
...
urlpatterns = [
    ...
    path('view_response/<uuid:pk>/update/', UpdateResponseFeedback, name='UpdateResponseFeedback')
]
