...
urlpatterns = [
    ...
    path('password-reset-complete/', views.PasswordResetCompleteView.as_view(template_name='registration/password_reset_complete.html'),name="password_reset_confirm"),
