...
class TemplateNodeResponse(models.Model):
    ...
    parent_template_response = models.ForeignKey('conversation_templates.TemplateResponse', default=0, null=True, blank=True, related_name='node_responses', on_delete=models.CASCADE)
    ...
    position_in_sequence = models.IntegerField(null=True, blank=True)
