# Generated by Django 3.1.3 on 2020-12-31 21:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='users.customuser')),
                ('added_by', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='students', to='users.researcher')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label_name', models.CharField(default=None, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_labels', models.ManyToManyField(blank=True, related_name='assignments', to='users.SubjectLabel')),
